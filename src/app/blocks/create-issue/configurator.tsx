...
export default Workflows.defineConfigurator(block, (workflowBlock) => {
    const {ComboboxInput, TextInput, Outcome, watch} = Workflows.useConfigurator(
    ...
    const projectIssueProvider = usePlainProvider(useProjectsIssuesProvider("workspace-connection"))
